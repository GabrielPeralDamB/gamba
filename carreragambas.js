...
loader.load("prawn/scene.gltf", function (gltf) {
    loader.load("mario/scene.gltf", function (marioGltf) {
        ...
        marioModel = marioGltf.scene;
        marioModel.scale.set(1, 1, 1);
        console.log("hola"); // Ajustar escala del modelo
        ...
        for (let i = 0; i < numHorses; i++) {
            ...
            // Colocar la gamba o Mario en el centro de cada carril
            horse.position.set(
                -trackLength / 2,
                0,
            ...
            // Añadir modelo de gamba o Mario a la escena de selección
            let selectionHorse;
            if (i === marioIndex && marioModel) {
            ...
            // Añadir número de gamba o Mario
            ...
            prawnNumber.innerText = i === marioIndex ? `Mario` : `Gamba ${i + 1}`;
            ...
            // Animar modelo de gamba o Mario en la selección con animaciones aleatorias
